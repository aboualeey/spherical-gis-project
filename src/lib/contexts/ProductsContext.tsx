...
const initialProducts: Product[] = [
    ...
    },
    {
      ...
      description: "Maximum Power Point Tracking charge controllers for optimizing solar panel efficiency and battery charging.",
      price: 180000,
    ...
    },
    {
      ...
      description: "Pulse Width Modulation charge controllers offering reliable and cost-effective battery charging solutions.",
      price: 85000,
      category: "Charge Controllers",
      imageUrl: "/victron_charge_controller_250_100_1.png",
      specifications: "10A - 60A capacity",
      inStock: true
    },
    {
      id: 11,
      name: "DC Disconnect Switches",
      description: "Safety disconnect switches for isolating solar panels from the electrical system during maintenance.",
      price: 45000,
      category: "Accessories",
      imageUrl: "/solar-panel-1.jpg",
      specifications: "Various amperage ratings",
      inStock: true
    },
    {
      id: 12,
      name: "AC Disconnect Switches",
      description: "AC disconnect switches for safely isolating inverters from the electrical grid.",
      price: 55000,
      category: "Accessories",
      imageUrl: "/solar-panel-1.jpg",
      specifications: "Grid-tie compatible",
      inStock: true
    },
    {
      id: 13,
...
export function ProductsProvider({ children }: ProductsProviderProps) {
  ...
  useEffect(() => {
    if (products.length > 0) {
      localStorage.setItem('spherical_products', JSON.stringify(products));
    }
  }, [products]);
